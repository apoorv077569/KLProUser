      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (data?.serviceStartOtp != null && data?.isOtpVerified == false && data!.bookingStatus?.slug != appFonts.completed && data!.bookingStatus?.slug != appFonts.cancelled && data!.bookingStatus?.slug != appFonts.cancel)
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          language(context, "Service Start OTP"),
                          style: appCss.dmDenseMedium12.textColor(appColor(context).lightText),
                        ),
                        const VSpace(Sizes.s5),
                        Text(
                          data!.serviceStartOtp!,
                          style: appCss.dmDenseBold20.textColor(appColor(context).primary),
                        ),
                      ],
                    ),
                    Icon(
            ...
            Column(
              ...
              children: [
                ...
                if (data!.bookingStatus?.slug != appFonts.cancel &&
                    ...
                    data!.bookingStatus?.slug != appFonts.completed)
                  Divider(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          CommonImageLayout(
                            ...
                            width: Sizes.s40,
                            isCircle: true,
                            assetImage: eImageAssets.placeholder,
                      ...
                      if (data!.provider!.reviewRatings != null)
                        Row(
                          children: [
                            SvgPicture.asset(eSvgAssets.star),
                            const HSpace(Sizes.s4),
                    ...
                    child: Column(
                      children: [
                        Row(
                              ...
                              Text(
                                  language(
                                      context, translations!.providerDetails),
                                  style: appCss.dmDenseMedium12
                                      .textColor(appColor(context).lightText)),
                              Row(
                                children: [
                        ...
                        if (data!.service != null &&
                            data!.bookingStatus?.slug != appFonts.pending &&
                            data!.bookingStatus?.slug != appFonts.completed &&
                            data!.bookingStatus?.slug != appFonts.cancelled &&
                            data!.bookingStatus?.slug != appFonts.cancel)
                          Row(
...
/*                                            } else if (e.value["title"] ==
                                              ...
                                              right: e.key != (appArray.remotelySocialList.where((element) => element["title"] != translations!.wp).length - 1) ? 10 : 0),
                                    )
                                    .toList()
                                : appArray.socialList
                                    .asMap()
...
/*                                          } else if (e.value["title"] ==
                                          ...
                                          right: e.key != (appArray.socialList.where((element) => element["title"] != translations!.wp).length - 1) ? 10 : 0),
                                    )
                                    .toList(),
                          ).paddingSymmetric(horizontal: Insets.i15),
                        // if (data!.bookingStatus?.slug == appFonts.accepted || data!.bookingStatus?.slug == appFonts.ongoing || data!.bookingStatus?.slug == appFonts.onthewayStatus)
                        if ((data!.bookingStatus?.slug == appFonts.accepted ||
                          ...
                          SocialButtonCommon(
                            ...
                            onTap: () {
                              route.pushNamed(context, routeName.liveTracking, arg: {
                                "bookingId": data!.id,
                              });
                            },
                          ).paddingSymmetric(horizontal: Insets.i15).paddingOnly(top: Insets.i10),
                        const VSpace(Sizes.s15),
                        if (isLayout &&
