      ...
      decoration:isCircle?   BoxDecoration(
        shape: BoxShape.circle,
          border: isBorder ? Border.all(
              ...
              width: 4):null,
          image: DecorationImage(image: AssetImage(image ?? eImageAssets.noImageFound1), fit: BoxFit.cover)):  ShapeDecoration(
          image: DecorationImage(
              image: AssetImage(image ?? eImageAssets.noImageFound1), fit:boxFit?? BoxFit.cover),
    ...
    return Container(
        ...
        decoration: isCircle
            ...
            border: isBorder
                ...
                : null,
            image: DecorationImage(image: image ?? AssetImage(eImageAssets.noImageFound1), fit: BoxFit.cover))
            : ShapeDecoration(

            image:
            DecorationImage(image: image ?? AssetImage(eImageAssets.noImageFound1), fit: boxFit ?? BoxFit.cover),
            shape: SmoothRectangleBorder(
