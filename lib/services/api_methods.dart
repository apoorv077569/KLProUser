...
class ApiMethods {
  ...
  String sendRegisterOtp = '$apiUrl/send-register-otp';
  String verifyRegisterOtp = '$apiUrl/verify-register-otp';
  ...
  String advertisement = '$apiUrl/advertisement?advertisement_type=banner&app_screen=category';
  ...
  String userZoneServicemen = '$apiUrl/user-zone-servicemen';
  String syncCart = '$apiUrl/cart';
  String getCart = '$apiUrl/cart';
  String cart = '$apiUrl/cart';
  String deleteCart = '$apiUrl/cart';
  String helpTicket = '$apiUrl/help-tickets';
  String checkServiceAvailability = '$apiUrl/check-service-availability';
}
