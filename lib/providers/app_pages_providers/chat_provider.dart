...
import 'package:klpro_user/screens/app_pages_screens/chat_screen/layouts/chat_layout.dart';
...
class ChatProvider with ChangeNotifier {
  ...
  Future<void> onReady(context) async {
    try {
      ...
      if (userModel == null) {
        log("Chat initialization skipped - User is not logged in (Guest Account)");
        return;
      }
