...
import 'package:klpro_user/models/category_service_model.dart'
    as CategoryServices;
import 'package:klpro_user/screens/app_pages_screens/category_detail_screen/layouts/categories_filter.dart';
...
class CategoriesDetailsProvider with ChangeNotifier {
  ...
  Future<void> getCategoryService({int? id}) async {
    ...
    try {
      ...
      final url = '${api.categoryService}?category_id=$id';
...
// Check if the response is successful
  ...
  Future<void> getService({int? id, String? search}) async {
    try {
      ...
      String url = '${api.categoryService}?category_id=$id';
  ...
  getServiceByCategoryId(context, {id}) async {
    ...
    try {
      ...
      String apiUrl = "${api.service}?categoryIds=$id";
