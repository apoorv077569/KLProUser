...
*/
  ...
  onFeatured(context, services, id) async {
    ...
    onBook(context, services!,
      ...
      if (service != null &&
          ...
          id < service!.relatedServices!.length) {
        service!.relatedServices![id].selectedRequiredServiceMan =
            service!.relatedServices![id].requiredServicemen;
      }
      notifyListeners();
  ...
  onRemoveService(context, {id}) async {
    if (id != null) {
      if ((service!.relatedServices![id].selectedRequiredServiceMan ?? 1) == 1) {
        route.pop(context);
        isAlert = false;
        notifyListeners();
      } else {
        if ((service!.relatedServices![id].requiredServicemen) ==
          ...
          notifyListeners();
          service!.relatedServices![id].selectedRequiredServiceMan =
              ((service!.relatedServices![id].selectedRequiredServiceMan ?? 1) - 1);
        }
      }
    } else {
      if ((service!.selectedRequiredServiceMan ?? 1) == 1) {
        route.pop(context);
        isAlert = false;
        notifyListeners();
      } else {
        if ((service!.requiredServicemen) ==
          ...
          notifyListeners();
          service!.selectedRequiredServiceMan =
              ((service!.selectedRequiredServiceMan ?? 1) - 1);
        }
      }
    }
    notifyListeners();
  ...
  onAdd({id}) {
    ...
    if (id != null) {
      log("count:::$id");
      int count = (service!.relatedServices![id].selectedRequiredServiceMan ?? 1);
      count++;
      service!.relatedServices![id].selectedRequiredServiceMan = count;
    } else {
      int count = (service!.selectedRequiredServiceMan ?? 1);
      log("count:::$count");
      count++;
      service!.selectedRequiredServiceMan = count;
    }
