...
import 'package:klpro_user/models/is_valid_time_slot_model.dart';
    ...
    if (data['availableProviders'] != null) {
      ...
      servicemanList = available.map((e) {
        return ProviderModel(
          id: e.id,
          name: e.name,
          reviewRatings: e.reviewRatings?.toDouble(),
          media: e.profileImage != null
              ? [Media(originalUrl: e.profileImage)]
              : [],
        );
      }).toList();
