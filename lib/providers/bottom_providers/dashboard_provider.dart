...
class DashboardProvider with ChangeNotifier {
  ...
  onRefresh(context) async {
    ...
    await common.getDashboardHome(context);
    await common.getDashboardHome2(context);
    await getJobRequest();
  ...
  Future<void> getFeaturedPackage(page) async {
    ...
    try {
      String apiLink = "${api.featuredServices}?paginate=10&page=$page";
...
*/
  ...
  onFeatured(context, Services? services, id, {inCart}) async {
    ...
    onBook(
      ...
      if (services != null) {
        services.selectedRequiredServiceMan = services.requiredServicemen;
      }
      notifyListeners();
    });
    // }
