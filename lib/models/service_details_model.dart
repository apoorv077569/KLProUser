...
class RelatedService {
  ...
  final dynamic isFeatured;
  final dynamic discount;
  List<dynamic>? selectedAdditionalServices;
...
import 'package:klpro_user/models/service_faq_model.dart';
...
class ServiceDetailsModel {
  ...
  final List<ServiceFaqModel>? faqs;
  final String? tax;
  ...
  factory ServiceDetailsModel.fromJson(Map<String, dynamic> json) {
    return ServiceDetailsModel(
      ...
      faqs: json["faqs"] == null
          ? []
          : List<ServiceFaqModel>.from(
              json["faqs"]!.map((x) => ServiceFaqModel.fromJson(x))),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        "tax": tax,
        "is_advance_payment_enabled": advancePaymentEnabled,
  ...
  String get discountDisplay {
    ...
    return double.parse(discount.toString()) % 1 == 0
        ? double.parse(discount.toString()).toInt().toString()
        : double.parse(discount.toString()).toString();
  }
}
