...
class ExpertiseModel {
  ...
  ExpertiseModel(
      ...
      this.serviceType,
      this.bookingsCount,
      this.isAdvancePaymentEnabled,
      this.advancePaymentPercentage});

  ExpertiseModel.fromJson(Map<String, dynamic> json) {
    title = json['title'];
    id = json['id'];
    reviewRatings = json['review_ratings'] != null ? json['review_ratings'].cast<int>() : [];
    ...
    isAdvancePaymentEnabled = json['is_advance_payment_enabled'];
