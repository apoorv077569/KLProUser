...
class CreatedBy {
  ...
  factory CreatedBy.fromJson(Map<String, dynamic> json) => CreatedBy(
        id: json["id"],
        name: json["name"] != null ? nameValues.map[json["name"]] ?? Name.ADMIN : Name.ADMIN,
      );
...
class Tag {
  ...
  factory Tag.fromJson(Map<String, dynamic> json) => Tag(
        id: json["id"],
        name: json["name"],
        type: json["type"] != null ? typeValues.map[json["type"]] ?? Type.BLOG : Type.BLOG,
      );
...
class HomeAdvertisement {
  ...
  factory HomeAdvertisement.fromJson(Map<String, dynamic> json) =>
      HomeAdvertisement(
        id: json["id"],
        bannerType: json["banner_type"] != null ? bannerTypeValues.map[json["banner_type"]] ?? BannerType.IMAGE : BannerType.IMAGE,
  ...
  FeaturedServices.fromJson(Map<String, dynamic> json) {
    ...
    if (json['user'] != null) {
      if (json['user'] is Map) {
        ...
        user = User.fromJson((json['user'] as List).first);
      }
    }
  }
