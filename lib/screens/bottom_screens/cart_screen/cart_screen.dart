                            ...
                            child: Column(
                              ...
                              children: [
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    // Replace ONLY this part inside cart_screen.dart
                                    ...value.cartList.asMap().entries.map(
                                      (e) => InkWell(
                                        onTap: () {
                                          ...
                                          /// NORMAL SERVICE
                                          if (cartItem.isPackage == false &&
                                              cartItem.serviceList != null) {
                                            route.pushNamed(
                                              context,
                                              routeName.selectServiceScreen,
                                              arg: {
                                                "services":
                                                    cartItem.serviceList,
                                                "id": cartItem.serviceList!.id,
                                              },
                                            );
                                          }
                                          /// PACKAGE SERVICE
                                          else if (cartItem.isPackage == true &&
                                              cartItem.servicePackageList !=
                                                  null) {
                                            route.pushNamed(
                                              context,
                                              routeName.selectServiceScreen,
                                        ...
                                        child: CartLayout(
                                          ...
                                          infoTap: () => value.addOns(
                                            context,
                                            data: e.value.serviceList,
                                          ),

                                          editTap: () {
                                            log(
                                              "editTap:::${e.value} //// ${e.key}",
                                            );
                                            value.editCart(
                                              e.value,
                                              context,
                            ...
                            Align(
                              ...
                              child:
                                  CartBottomLayout(
                                    ...
                                    onTap: () {
                                      debugPrint(
                                        "APPU_DEBUG OPEN SERVICEMAN LIST",
                                      );
