...
class FeaturedServicesLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer3<CategoriesDetailsProvider, ChatProvider,
      ...
      final double imageHeight = (screenHeight * 0.22).clamp(160.0, 220.0);
      return ClipRRect(
                    ...
                    Stack(alignment: Alignment.topRight, children: [
                      ...
                      if (data?.status == 0)
                        Container(
                                ...
                                height: Sizes.s230,
                                child: Text(
                                        translations!.unavailableService
                                            .toString(),
                                    ...
                                    .decorated(
                                        ...
                                        color: appColor(context)
                                            ...
                                            .withOpacity(0.8)))
                            .decorated(
                          color: appColor(context).whiteColor.withOpacity(0.5),
                        ),
                      Row(
                          ...
                          children: [
                            Container(),
                            if (data?.isFeatured != null && data?.isFeatured != 0)
                              SizedBox(
                        ...
                        Row(
                            ...
                            children: [
                              ...
                              if (data!.discount != null && data!.discount > 0)
                                SizedBox(
                                        child: Text(
                                                "${data!.discountDisplay}% ${language(context, translations!.off)}",
                                                style: appCss.dmDenseMedium12
                                                    .textColor(appColor(context)
                                                        .whiteColor))
                                            .padding(
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          IntrinsicHeight(
                            ...
                            const HSpace(Sizes.s5),
                            Flexible(
                                child: Text("${data?.duration ?? ''} ${data?.durationUnit != null ? capitalizeFirstLetter(data!.durationUnit.toString().split('.').last.toLowerCase()) : ''}",
                                    overflow: TextOverflow.ellipsis,
                                    style: appCss.dmDenseSemiBold12
                                        .textColor(appColor(context).online))),
                          ])),
                          if (data?.status == 1) const VSpace(Sizes.s6),
                          if (data?.status == 1)
                            Row(
...
/*                                   Expanded(
                                    child: Align(
                                      ...
                                      child: CommonArrow(
                                          ...
                                          onTap: () async {
                                            ...
                                            for (var doc in chatHistoryProvider
                                                .chatHistory) {
                                              final d = doc.data()
                                            ...
                                            route.pushNamed(context,
                                                ...
                                                arg: {
                                                  "image": data?.user?.media != null &&
                                                          (data?.user?.media as List).isNotEmpty
                                                      ? data!.user!.media![0].originalUrl ?? ""
                                                      : "",
                                                  "name": data?.user?.name ?? "",
                                                  "role": "user",
                        ...
                        ]).padding(horizontal: Insets.i14, vertical: Insets.i10)
                  ])))
          .decorated(
              color: data?.status == 1
                  ? appColor(context).whiteBg
