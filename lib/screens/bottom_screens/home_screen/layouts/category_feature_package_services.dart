...
import 'package:klpro_user/screens/bottom_screens/home_screen/layouts/horizontal_service_package_list.dart';
                    ...
                    itemBuilder: (context, index) {
                      return TopCategoriesLayout(
                        ...
                        onTap: () async {
                          ...
                          // Navigate immediately — detail screen onReady() handles APIs + shimmer
        ...
        builder: (context3, dash, value, cart, commonApi, categoryDetails,
          ...
          return Column(children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              // ── Special Offers ──
              if (commonApi.dashboardModel2 != null &&
                  commonApi.dashboardModel2!.homeServicesAdvertisements!.isNotEmpty)
                const SizedBox(height: 269, child: SpecialOffersLayout()),
              const VSpace(Sizes.s40),
