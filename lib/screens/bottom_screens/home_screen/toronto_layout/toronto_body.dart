...
import 'package:klpro_user/screens/bottom_screens/home_screen/toronto_layout/toronto_coupon_layout.dart';
import 'package:klpro_user/screens/bottom_screens/home_screen/toronto_layout/toronto_package_layout.dart';
    ...
    return Consumer3<DashboardProvider, HomeScreenProvider, CommonApiProvider>(
      ...
      return StatefulWrapper(
        ...
        child: ListView(children: [
          ...
          Consumer3<CommonApiProvider, DashboardProvider,
              CategoriesDetailsProvider>(
            builder: (ctx, commonApi2, dash, categoryDetails, _) {
              if (commonApi2.dashboardModel == null ||
                  commonApi2.dashboardModel!.categories!.isEmpty)
                    ...
                    itemBuilder: (context, index) {
                      return FeaturedServicesLayout(
                          ...
                          onTap: () {
                            ...
                            log("pref.getBool(session.isContinueAsGuest::}");
