...
import 'package:klpro_user/screens/bottom_screens/home_screen/berlin_layout.dart/berlin_package_layout.dart';
import 'package:klpro_user/screens/bottom_screens/home_screen/berlin_layout.dart/berline_job_request.dart';
import 'package:klpro_user/screens/bottom_screens/home_screen/berlin_layout.dart/berline_today_offiers.dart';
import 'package:klpro_user/screens/bottom_screens/home_screen/berlin_layout.dart/berlin_coupon_layout.dart';
import 'package:klpro_user/screens/bottom_screens/home_screen/dubai_layout/dubai_services.dart';
import 'package:klpro_user/screens/bottom_screens/home_screen/layouts/horizontal_blog_list.dart';
import 'package:klpro_user/screens/bottom_screens/home_screen/layouts/special_offers_layout.dart';
              ...
              Expanded(
                child: ListView(
                  children: [
                    ...
                    /// Banner first, then grid categories below
                    Column(children: [
                    ...
                    // Grid Categories below banner
                    if (commonApi.dashboardModel != null &&
                        commonApi.dashboardModel!.categories!.isNotEmpty)
                      Consumer2<DashboardProvider, CategoriesDetailsProvider>(
                          builder: (ctx, dash, categoryDetails, _) {
                        return Column(children: [
                          ...
                          GridView.builder(
                              ...
                              padding: const EdgeInsets.symmetric(
                                  horizontal: Sizes.s16, vertical: Sizes.s4),
                              itemCount: (homeCategoryList.length > 8
                                  ? 8
