...
import 'package:klpro_user/screens/bottom_screens/booking_screen/layouts/booking_layout.dart';
        ...
        return StatefulWrapper(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  leadingWidth: 80,
                  title: Text(
                    language(context, translations?.bookings ?? "Bookings"),
                      ...
                      return Column(
                          ...
                          children: [
                            EmptyLayout(
                                ...
                                subtitle: "",
                                buttonText: translations?.login ?? "Login",
                                isBooking: true,
                                isButtonShow: true,
                                bTap: () async {
                                  ...
                                  if (mounted &&
                                      (login.pref?.getBool(
                                              session.isContinueAsGuest) ?? true) ==
                                          false) {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        SearchTextFieldCommon(
                                            ...
                                            hinText: language(
                                                context,
                                                translations?.searchWithBookingId ?? "Search with Booking ID"),
                                            ...
                                            children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        Text(
                                                                language(
                                                                    context,
                                                                    translations?.allBooking ?? "All Bookings"),
                                                                style: appCss
                                                                    .dmDenseMedium18
                                                                    .textColor(appColor(
                                                                            context)
                                              ...
                                              value.isLoadingForBookingHistory &&
                                                  ...
                                                  : value.bookingList
                                                      ...
                                                      : EmptyLayout(
                                                          isButtonShow: false,
                                                          title: translations?.yourBookingList ?? "Your booking list is empty",
                                                          subtitle: '',
                                                          widget: SizedBox(
                                                              height:
                                                                  Sizes.s306,
