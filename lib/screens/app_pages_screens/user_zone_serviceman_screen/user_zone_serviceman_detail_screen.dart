...
class UserZoneServicemanDetailScreen extends StatelessWidget {
  const UserZoneServicemanDetailScreen({super.key});
    ...
    return Consumer<ServicemanDetailProvider>(builder: (context, value, child) {
      return StatefulWrapper(
        ...
        child: LoadingComponent(
          child: Scaffold(
            appBar: AppBarCommon(title: language(context, "Provider Details")),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (value.provider!.description != null && value.provider!.description!.isNotEmpty) ...[
                          Text(language(context, "About"), style: appCss.dmDenseSemiBold16.textColor(appColor(context).darkText)),
                        ...
                        // Contact Information
                        Text(language(context, "Contact Information"), style: appCss.dmDenseSemiBold16.textColor(appColor(context).darkText)),
                        ...
                        if (value.provider!.knownLanguages != null && value.provider!.knownLanguages!.isNotEmpty) ...[
                          Text(language(context, "Known Languages"), style: appCss.dmDenseSemiBold16.textColor(appColor(context).darkText)),
                          const VSpace(Sizes.s15),
                          Wrap(
                            spacing: Sizes.s10,
                        ...
                        if (value.provider!.expertise != null && value.provider!.expertise!.isNotEmpty) ...[
                          Text(language(context, "Featured Services"), style: appCss.dmDenseSemiBold16.textColor(appColor(context).darkText)),
                          const VSpace(Sizes.s15),
                          ListView.builder(
                            shrinkWrap: true,
