...
import 'package:klpro_user/screens/app_pages_screens/provider_details_screen/layouts/choose_serviceman_layout.dart';
import 'package:klpro_user/screens/app_pages_screens/provider_details_screen/layouts/service_layout.dart';
                        ...
                        children: [
                          ServiceLayout(
                            ...
                            image:
                                ...
                                : null,
                            price:
                                ( /* int.parse(requiredServiceMan.toString()) * */ price!)
                                    .toString(),
                            style: style,
                          ...
                          Text(
                            language(context, translations!.chooseOneOf),
                                    ...
                                    .map(
                                      (e) => ChooseServicemanLayout(
                                        ...
                                        onTap: () {
                                          ...
                                          /// FORCE SAME CALENDAR FLOW
                                          /// FOR BOTH AUTO + MANUAL SERVICEMAN

                                          services.selectServiceManType =
                                              "app_choose";

                                          debugPrint(
                                            "APPU_DEBUG SAME CALENDAR FLOW ENABLED",
                                          );
                        ...
                        onTap: () {
                          isGuest == true
                              ...
                              : serviceCtrl.onTapBook(
                                  ...
                                  index: packageServiceId,
                                  providerId:
                                      services.user?.id ?? services.userId,
                                  providerModel: providerModel,
                                  selectProviderIndex:
                                      value.selectProviderIndex,
                                );
