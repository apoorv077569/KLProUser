...
/*   int count = 1; */ // 👈 default quantity
  ...
  Widget build(BuildContext context) {
    ...
    final duration = widget.additionalServices is Map<String, dynamic>
        ? widget.additionalServices['duration']
        : widget.additionalServices.duration;
    final durationUnit = widget.additionalServices is Map<String, dynamic>
        ? widget.additionalServices['duration_unit']
        : widget.additionalServices.durationUnit;
                ...
                Row(
                  children: [
                    ...
                    if (duration != null &&
                        ...
                        durationUnit != null &&
                        durationUnit.toString().isNotEmpty)
                      Text(
