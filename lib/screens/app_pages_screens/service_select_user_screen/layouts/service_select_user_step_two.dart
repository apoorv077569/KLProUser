            ...
            return Stack(
              children: [
                    ...
                    children: [
                                      ...
                                      .map<Widget>(
                                        (e) => ServicemanLayout(
                                          ...
                                          rate: e.value.reviewRatings != null
                                              ...
                                              : "0",
                                          exp:
                                              e.value.experienceDuration != null
                                              ? e.value.experienceDuration
                                                    .toString()
                                              : "0",
                                          expYear:
                                              e.value.experienceInterval ??
                                              "Year",
                                          editTap: () => route
                                              .pushNamed(
                                                context,
                      ...
                      if (slot.selectedDateList.isNotEmpty &&
                          ...
                          (value.servicesCart!.type == "scheduled" ||
                              value.servicesCart!.type == "schedule"))
                        Container(
                ...
                ButtonCommon(
                      ...
                      onTap: () {
                        debugPrint("APPU_DEBUG FINAL BOOKING");
                        ...
                        debugPrint("APPU_DEBUG BOOKING CREATED");
                        ...
                        debugPrint("APPU_DEBUG ORDER SCREEN OPEN");
                      },
