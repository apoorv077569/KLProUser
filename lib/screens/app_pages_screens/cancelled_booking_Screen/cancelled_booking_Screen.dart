    ...
    return Consumer<CancelledBookingProvider>(builder: (context1, val, child) {
      ...
      return StatefulWrapper(
        ...
        child: PopScope(
          ...
          child: Scaffold(
              appBar: AppBarCommon(
                title: translations?.cancelledBooking ?? "Cancelled Booking",
                onTap: () {
                ...
                child: val.isLoading || val.booking == null
                    ...
                    : SingleChildScrollView(
                        child: Column(
                              ...
                              Text(language(context, translations?.billSummary ?? "Bill Summary"),
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          BillRowCommon(
                                              title: translations?.perServiceCharge ?? "Per Service Charge",
                                          ...
                                          BillRowCommon(
                                                  title:
                                                      "${((val.booking?.requiredServicemen ?? 1) + (val.booking?.totalExtraServicemen != null ? (val.booking?.totalExtraServicemen ?? 1) : 0))} ${language(context, translations?.serviceman ?? "Serviceman")}",
                                                  price: symbolPosition
                                          ...
                                          if (val.booking?.service?.discount !=
                                            ...
                                            BillRowCommon(
                                                    ...
                                                    title:
                                                        "${translations?.appliedDiscount ?? "Applied Discount"} (${val.booking?.service?.discount ?? 0}%)",
