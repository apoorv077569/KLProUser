...
import 'package:klpro_user/screens/app_pages_screens/serviceman_list_screen/layouts/serviceman_list_layout.dart';
...
class _ServicemanListScreenState extends State<ServicemanListScreen>
  ...
  ServicemanListProvider? _provider;

  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    _provider ??= Provider.of<ServicemanListProvider>(context, listen: false);
  }

  @override
  void dispose() {
    if (_provider != null && _provider!.animationController != null) {
      _provider!.animationController!.dispose();
      _provider!.animationController = null;
    }
    super.dispose();
  }
